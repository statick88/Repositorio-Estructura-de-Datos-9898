    ...
    if videojuegos:
        ...
        for videojuego in videojuegos:
            if videojuego.nombre == nombre:
                ...
                nuevo_anio = int(input("Ingrese el nuevo año de lanzamiento del videojuego: "))
...
def menu():
    ...
    while True:
        ...
        print("6. Ordenar videojuegos por año de lanzamiento")
        print("0. Salir")
        ...
        if opcion == "1":
            ...
            anio = int(input("Ingrese el año de lanzamiento del videojuego: "))
